...
def version():
    with open('octodns_api/__init__.py') as fh:
        for line in fh:
...
setup(
    ...
    entry_points={'console_scripts': ['octodns-api=octodns_api.cli:main']},
    extras_require={
        'dev': tests_require
        + (
    ...
    install_requires=('octodns>=1.5.0', 'Flask>=2.3.0', 'flask-cors>=4.0.0'),
    license='MIT',
    ...
    url='https://github.com/octodns/octodns-api',
    version=version(),
)
